...
func (s *system) UpdateWorkspaceSessionTitle(ctx context.Context, workspaceID string, roleID string, sessionID string, title string) (types.Session, error) {
	return s.updateSessionTitle(ctx, workspaceSessionScope(workspaceID, roleID), sessionID, title)
}
...
func (s *system) UpdateWorkspaceSessionMessage(ctx context.Context, workspaceID string, roleID string, sessionID string, messageID string, patch types.SessionMessagePatch) (types.Message, error) {
	return s.updateSessionMessage(ctx, workspaceSessionScope(workspaceID, roleID), sessionID, messageID, patch)
}
...
func (s *system) DeleteWorkspaceSessionMessage(ctx context.Context, workspaceID string, roleID string, sessionID string, messageID string) (types.Session, error) {
	return s.deleteSessionMessage(ctx, workspaceSessionScope(workspaceID, roleID), sessionID, messageID)
}
...
func (s *system) DeleteWorkspaceSessionMessageSubtree(ctx context.Context, workspaceID string, roleID string, sessionID string, messageID string) (types.Session, error) {
	return s.deleteSessionMessageSubtree(ctx, workspaceSessionScope(workspaceID, roleID), sessionID, messageID)
}
