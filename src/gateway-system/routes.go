...
func (s *system) registerRoutes() {
	...
	s.mux.HandleFunc("PATCH /api/groups/{groupID}/sessions/{sessionID}/settings", s.authWrap(s.handleUpdateGroupSessionSettings))
	...
	s.mux.HandleFunc("PATCH /api/workspaces/{workspaceID}/roles/{roleID}/sessions/{sessionID}/settings", s.authWrap(s.handleUpdateWorkspaceSessionSettings))
	...
	s.mux.HandleFunc("PATCH /api/roles/{roleID}/sessions/{sessionID}/settings", s.authWrap(s.handleUpdateSessionSettings))
