...
func (s *system) registerRoutes() {
	...
	s.mux.HandleFunc("GET /api/workspaces/{workspaceID}/sessions", s.authWrap(s.handleListWorkspaceSessions))
	s.mux.HandleFunc("POST /api/workspaces/{workspaceID}/sessions/create", s.authWrap(s.handleCreateWorkspaceSession))
	s.mux.HandleFunc("POST /api/workspaces/{workspaceID}/sessions", s.authWrap(s.handleSaveWorkspaceSession))
	s.mux.HandleFunc("GET /api/workspaces/{workspaceID}/sessions/{sessionID}", s.authWrap(s.handleLoadWorkspaceSession))
	s.mux.HandleFunc("DELETE /api/workspaces/{workspaceID}/sessions/{sessionID}", s.authWrap(s.handleDeleteWorkspaceSession))
	s.mux.HandleFunc("PATCH /api/workspaces/{workspaceID}/sessions/{sessionID}/title", s.authWrap(s.handleUpdateWorkspaceSessionTitle))
	s.mux.HandleFunc("PATCH /api/workspaces/{workspaceID}/sessions/{sessionID}/messages/{messageID}", s.authWrap(s.handleUpdateWorkspaceSessionMessage))
	s.mux.HandleFunc("DELETE /api/workspaces/{workspaceID}/sessions/{sessionID}/messages/{messageID}", s.authWrap(s.handleDeleteWorkspaceSessionMessage))
	s.mux.HandleFunc("DELETE /api/workspaces/{workspaceID}/sessions/{sessionID}/messages/{messageID}/subtree", s.authWrap(s.handleDeleteWorkspaceSessionMessageSubtree))
