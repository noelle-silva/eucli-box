...
import (
	...
	"devtools/general-verification-tools/verify-data-migration/migrationverify"
)
...
func run(ctx context.Context, args []string) error {
	flags := flag.NewFlagSet("verify-data-migration", flag.ContinueOnError)
	...
	return migrationverify.Run(ctx, *rootValue, *runRootValue, *modeValue)
}
